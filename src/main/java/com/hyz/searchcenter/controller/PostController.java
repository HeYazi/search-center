...
import com.hyz.searchcenter.annotation.AuthCheck;
import com.hyz.searchcenter.common.BaseResponse;
import com.hyz.searchcenter.common.DeleteRequest;
import com.hyz.searchcenter.common.ErrorCode;
import com.hyz.searchcenter.common.ResultUtils;
import com.hyz.searchcenter.constant.UserConstant;
import com.hyz.searchcenter.exception.BusinessException;
import com.hyz.searchcenter.exception.ThrowUtils;
import com.hyz.searchcenter.model.dto.post.PostAddRequest;
import com.hyz.searchcenter.model.dto.post.PostEditRequest;
import com.hyz.searchcenter.model.dto.post.PostQueryRequest;
import com.hyz.searchcenter.model.dto.post.PostUpdateRequest;
...
//            current = postQueryRequest.getCurrent();
//            size = postQueryRequest.getPageSize();
//        }
        long current = postQueryRequest.getCurrent();
        long size = postQueryRequest.getPageSize();
        // 限制爬虫
        ThrowUtils.throwIf(size > 20, ErrorCode.PARAMS_ERROR);
        Page<PostVO> result = postService.listPostVOByPage(postQueryRequest, request);
        return ResultUtils.success(result);
    }
